...
// var mongodbMgr =  function (tablename, type, data, selector, cb) {
//     MongoClient.connect(Urls, {useNewUrlParser:true}, function (err, client) {
...
// mongodbMgr("user", "add", {name: "haoren"}, {}, function() {})
// mongodbMgr("user", "delete", {}, {name: "lo111"}, function() {})
// mongodbMgr("user", "find", {}, {name: "郭恩泽"}, function(res) {console.log(res);})
// mongodbMgr("user", "update", {name: "郭恩泽"}, {$set: {name: "大侠"}}, function () {})
